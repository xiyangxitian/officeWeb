...
public class ItextUtil {
    ...
    public static final char[] PASSWORD = "Aa123456".toCharArray();// keystory密码
    ...
    public void sign(String src, String target, SignatureInfo signatureInfo) {
        ...
        try {
            ...
            com.itextpdf.text.pdf.PdfReader reader = new PdfReader(inputStream);
...
//        String pathURL = PDFUtil.getPath();
        ...
        try {
            ...
            File pdfFile = new File("E:\\my\\pdf\\outFile.pdf");
            ...
            //找到关键字的位置，根据关键字进行平移和加签
            String keyword = "11.4";

           //使用另一篇文章中的找到关键字

          //https://mp.csdn.net/postedit/84560899
...
/*            String pkPath = "E:\\my\\pdf\\tool\\gongzhang.png";
            ...
            //需要进行签章的pdf
            String path = "E:\\my\\pdf\\outFile.pdf";
            // 封装签章信息
...
//            signInfo.setChain(chain);
            ...
            // 签章图片
            signInfo.setImagePath("E:\\my\\pdf\\tool\\gongzhang.png");
            ...
            //签章后的pdf路径
            app.sign(path, "E:\\my\\pdf\\finish.pdf", signInfo);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
